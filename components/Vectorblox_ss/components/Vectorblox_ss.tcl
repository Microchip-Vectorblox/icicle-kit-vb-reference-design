...
sd_connect_pins -sd_name ${sd_name} -pin_names {"core_vectorblox_C0_0:clk_2x" "vectorblox_axi_resize_0:ACLK" "aclk" "fast_reset:CLK" "PF_CCC_C0_0:OUT1_FABCLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"aclk_control" "slow_reset:CLK" "core_vectorblox_C0_0:clk" "PF_CCC_C0_0:OUT0_FABCLK_0" "vectorblox_axi_resize_0:M_CLK0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"slow_reset:PLL_LOCK" "PF_CCC_C0_0:PLL_LOCK_0" "fast_reset:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"REF_CLK_0" "PF_CCC_C0_0:REF_CLK_0" }
